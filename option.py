...
parser.add_argument('--seed', type=int, default=1,
                    help='random seed')
parser.add_argument('--data_dir', type=str, default='C:/Users/24100/Desktop/DFNet/dataset/data',
                    help='dataset directory')
                    
parser.add_argument('--data_train', type=str, default='FLIR',
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='Thermal700',
                    help='test dataset name')
parser.add_argument('--data_range', type=str, default='1-1000/1001-1116',
                    help='train/test data range')
parser.add_argument('--scale', type=int, default=2,
                    help='super resolution scale')
parser.add_argument('--patch_size', type=int, default=192,  #192,144,96
...
parser.add_argument('--n_feats', type=int, default=72,
...
parser.add_argument('--weight_decay', type=float, default=0,
                    help='weight decay')
parser.add_argument('--loss', type=str, default='1*L1+0.1*Gradient+0.01*FFT',
                    help='loss function configuration, L1|MSE')# 1*L1
